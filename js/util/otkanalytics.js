...
(function () {
  ...
  var _checkData = function () {
    ...
    if (
      _this.analyticsData.sessionId === null ||
      _this.analyticsData.sessionId.length === 0
    ) {
    ...
    if (
      _this.analyticsData.connectionId == null ||
      _this.analyticsData.connectionId.length === 0
    ) {
      console.log(
        'Error. The connectionId field cannot be null in the log entry'
      );
    ...
    if (
      _this.analyticsData.clientVersion == null ||
      _this.analyticsData.clientVersion.length === 0
    ) {
      console.log(
        'Error. The clientVersion field cannot be null in the log entry'
      );
      throw new Error(
        'The clientVersion field cannot be null in the log entry'
      );
    }
    if (
      _this.analyticsData.source == null ||
      _this.analyticsData.source.length === 0
    ) {
    ...
    if (
      _this.analyticsData.logVersion == null ||
      _this.analyticsData.logVersion.length === 0
    ) {
      _this.analyticsData.logVersion = '2';
    }
    if (
      _this.analyticsData.guid == null ||
      _this.analyticsData.guid.length === 0
    ) {
